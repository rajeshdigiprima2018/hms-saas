<div class="row mb-5">
    <div class="form-group col-md-3 mb-5">
        ...
        {{ Form::select('patient_id',$patients, null, ['class' => 'form-select','required','id' => 'edit_prescription_patient_id','placeholder'=>'Select Patient']) }}
    </div>
    ...
    @else
        <div class="form-group col-md-3 mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('doctor_id',$doctors, null, ['class' => 'form-select','required','id' => 'edit_prescription_doctor_id','placeholder'=> __('messages.web_home.select_doctor')]) }}
        </div>
    @endif
    <div class="col-md-3">
