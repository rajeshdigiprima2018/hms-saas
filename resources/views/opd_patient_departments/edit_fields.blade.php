    ...
    <div class="col-md-3">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="required"></span>
                {{ Form::select('payment_mode', $data['paymentMode'], null, ['class' => 'form-select', 'required', 'id' => 'editOpdPaymentMode', 'data-control' => 'select2', 'placeholder' => 'messages.opd_payments.choose_payment']) }}
            </div>
        </div>
    </div>
    <div class="col-md-6">
