            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('currency_name', '', ['id'=>'editAdminCurrencyName','class' => 'form-control','required']) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('currency_icon', '', ['id'=>'editAdminCurrencyIcon','class' => 'form-control','required']) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('currency_code', '', ['id'=>'editAdminCurrencyCode','class' => 'form-control','required']) }}
                    </div>
                </div>
