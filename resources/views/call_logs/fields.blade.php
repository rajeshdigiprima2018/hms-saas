...
<div class="row">
    ...
    <div class="form-group col-sm-6 mb-5">
        ...
        <br>
        {!! Form::tel('phone', null, ['class' => 'form-control iti phoneNumber', 'id' => 'callLogPhoneNumber', 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")', 'tabindex' => '5']) !!}
