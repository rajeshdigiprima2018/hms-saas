...
<a href="javascript:void(0)" title="<?php echo __('messages.common.delete') ?>" data-id={{:id}}" class="delete-prescription-btn btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
    <span class="svg-icon svg-icon-3">
